...
app.controller('CustomersController', ['$scope', 'simpleFactory', function ($scope, customersService) {
...
app.controller('CustomerOrdersController', ['$scope', '$routeParams','customersService', function ($scope, $routeParams, customersService) {
    $scope.customer = {};
...
app.controller('OrdersController',['$scope', 'simpleFactory', function ($scope, simpleFactory) {
    $scope.customers = [];
